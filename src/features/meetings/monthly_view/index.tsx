...
import AddCustomModalWindow from './add_custom_modal_window';
  ...
  return (
    <>
      ...
      <AddCustomModalWindow
        open={openAddCustomModalWindow}
        week={addCustomModalWindowWeek}
        closeFunc={() => {
          setOpenAddCustomModalWindow(false);
        }}
      />
    </>
  );
